...
class TestMappingFieldUpdateWithPropagation(unittest.TestCase):
    ...
    def _setup_test_fields(self):
        ...
        parent_field.actions_allowed = [Action.USE, Action.NOT_USE, Action.EMPTY, Action.EXTENSION]
        ...
        for child_name in child_fields:
            ...
            child_field.actions_allowed = [Action.USE, Action.NOT_USE, Action.EMPTY, Action.EXTENSION]
